...
docker run -d --restart=always --name activity0 --cpuset-cpus 0 --cpus 0.01 davequick/image:activity
docker run -d --restart=always --name activity1 --cpuset-cpus 1 --cpus 0.01 davequick/image:activity
docker run -d --restart=always --name activity2 --cpuset-cpus 2 --cpus 0.01 davequick/image:activity
docker run -d --restart=always --name activity3 --cpuset-cpus 3 --cpus 0.01 davequick/image:activity
docker run -d --restart=always --name activity4 --cpuset-cpus 4 --cpus 0.01 davequick/image:activity
docker run -d --restart=always --name activity5 --cpuset-cpus 5 --cpus 0.01 davequick/image:activity
docker run -d --restart=always --name activity6 --cpuset-cpus 6 --cpus 0.01 davequick/image:activity
docker run -d --restart=always --name activity7 --cpuset-cpus 7 --cpus 0.01 davequick/image:activity

docker run -d --restart=always --name healthcheck-local -p "6970:8080" davequick/image:activity
...
docker node update --label-add gg.dq.storage="medium" node14.dq.gg
docker node update --label-add gg.dq.storage="medium" node15.dq.gg
docker node update --label-add gg.dq.storage="small" node16.dq.gg
docker node update --label-add gg.dq.storage="small" node17.dq.gg
docker node update --label-add gg.dq.storage="small" node18.dq.gg
